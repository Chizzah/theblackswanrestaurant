<template>
  <footer class="text-gray-500 bg-black md:rounded-xl md:text-center md:mb-16">
    <section class="border-b border-gray-600 border-solid md:ml-24">
      ...
      <g-link to="/reservetable"><button class="px-6 py-3 mx-8 my-12 font-semibold text-gray-100 bg-red-700 rounded-xl focus:outline-none">Make A Reservation</button></g-link>
    </section>
    ...
    <section class="py-2 mx-4 text-xs text-center border-solid md:order-2 md:text-left">
      <p class="mb-4 md:ml-32">JAMstack Website by <span class="font-semibold hover:text-green-400">Chadd Web Design</span></p>
